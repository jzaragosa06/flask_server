...
#     trend_dict = convert_df_to_dict(trend_result)
#     seasonality_dict = convert_df_to_dict(seasonal_result)
#     pred_out_dict = convert_df_to_dict(pred_out)
#     pred_test_dict = convert_df_to_dict(pred_test)
#     train_data_dict = convert_df_to_dict(train_data)
#     test_data_dict = convert_df_to_dict(test_data)
#     df_dict = convert_df_to_dict(df)
